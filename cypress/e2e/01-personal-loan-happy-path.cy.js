...
describe('Personal Loan Happy Path (Salaried)', () => {
  ...
  it('completes full loan application and submits successfully', () => {
    ...
    cy.get('[class*="font-mono"]').should('be.visible');
    cy.contains('Apply for Another Loan').should('be.visible');
  });
});
